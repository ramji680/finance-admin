...
const Sidebar: React.FC<SidebarProps> = ({ isOpen, onToggle }) => {
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <div className={`
        fixed left-0 top-0 h-full w-64 bg-white/90 backdrop-blur-xl shadow-2xl border-r border-white/20 
      ...
      `}>
        ...
        <div className="p-4 border-t border-gray-100/50">
          ...
          >
            <div className="w-10 h-10 bg-red-100 rounded-lg flex items-center justify-center group-hover:bg-red-500 transition-colors duration-200">
      ...
      <button
        onClick={onToggle}
        className="fixed top-4 left-4 z-50 lg:hidden p-3 bg-white/90 backdrop-blur-sm rounded-xl shadow-lg border border-white/20"
      >
